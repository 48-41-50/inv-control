...
class Users(models.Model):
    ...
    userid          = models.CharField(max_length=25, null=False, blank=False)
    ...
    modified_by     = models.UUIDField(null=False)
...
class WarehouseContainers(models.Model):
    ...
    parent          = models.UUIDField(null=False)
...
class Pulls(models.Model):
    id                      = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    contract                = models.ForeignKey(Contracts, null=False)
